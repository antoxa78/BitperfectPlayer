 ...
 *
 * $Id: id3.h,v 1.12 2004/04/25 00:31:42 havard Exp $
 *
...
int id3_write_tag(struct id3_tag *, uint8_t *);

/* From id3_frame.c */
int id3_read_frame(struct id3_tag *id3);
struct id3_frame *id3_get_frame(struct id3_tag *, uint32_t, int);
int id3_delete_frame(struct id3_frame *frame);
struct id3_frame *id3_add_frame(struct id3_tag *, uint32_t);
...
int8_t id3_get_encoding(struct id3_frame *);
