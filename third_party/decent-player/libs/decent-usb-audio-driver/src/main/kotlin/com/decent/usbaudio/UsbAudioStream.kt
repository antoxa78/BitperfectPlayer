...
class UsbAudioStream(
    ...
    companion object {
        ...
        /**
         * Pure USB reset (no claiming) — forces a re-enumeration so the kernel
         * rebinds the system USB-audio driver (proxy pcm). Used when handing
         * the DAC back to the system (soft replug).
         * @return 0 on success, negative on error
         */
        @JvmStatic
